            ...
            >
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  ...
                  >
                    I accept the{" "}
                    <p className="font-medium text-primary-600 hover:underline dark:text-primary-500 inline-block">
              ...
              <div className=" w-full flex justify-center">
                <div className="bg-gray-700 rounded-lg w-1/2 hover:scale-125 transition duration-300">
                  <button
                    type="submit"
